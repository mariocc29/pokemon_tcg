      ...
      <section className='empty_state'>
        <main>
          <article className='row'>
            <div className='col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 pokeball'>
          ...
          <article className='row'>
            <div className='col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 message'>
